...
class TrainLoop:
    ...
    def run_step(self, batch, cond):
        ...
        end0 = time.time()
        print(f"sample time: {end0 - start0}")
        if self.clip:
    ...
    def forward_backward(self, batch, cond):
        ...
        for i in range(0, batch.shape[0], self.microbatch):
            ...
            # print('training para', t, micro.shape, micro_cond)
            compute_losses = functools.partial(   # 回
                self.diffusion.training_losses,
                self.ddp_model,
                micro,
                t,
                model_kwargs=micro_cond,  # condition for model
