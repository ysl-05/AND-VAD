...
class Upsample(nn.Module):
    ...
    :param dims: determines if the signal is 3D. 
    """

    def __init__(self, channels, use_conv, seq_factor, dims=3):
        super().__init__()
...
class Downsample(nn.Module):
    ...
    :param channels: channels in the inputs and outputs.
    :param use_conv: a bool determining if a convolution is applied.
    :param dims: determines if the signal is 3D, then
    ...
    def __init__(self, channels, use_conv, seq_factor, dims=3):
        ...
        if seq_factor == 0:
            ...
            d = 2
        # 3D下采样：时间维度根据seq_factor决定，空间维度减半
